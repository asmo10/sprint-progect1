...
public class Data {
	...
	private int ssn = 123456;
		...
		// getter: it's a method that can read the private data in other objects , a
		// return method
		// return-type of the getter has to be same with data type that we wanna return
		public int getSSN() {
			return ssn; // the value that method returns has to be same data type with the return-type
						// of the method
		}

		// setter: modifying the privtae data,or setting it's value.
		// return-type Has to be void, parameter' data type has to be same with the
		// instance varaible' data type
		// this: instance
